...
<body class="bg-cover bg-center bg-no-repeat min-h-screen text-white"
    ...
    <header class="absolute top-4 left-4 z-10">
        <img src="/assets/img/logo_hp.png" alt="Logo Apotek F21" class="h-14 w-auto sm:h-16" />
    </header>

    <!-- Konten Utama -->
    <main class="min-h-screen flex flex-col md:flex-row items-center justify-center px-4 sm:px-6 py-20 gap-10">
